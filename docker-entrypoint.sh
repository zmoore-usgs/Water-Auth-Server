...
keytool -v -importkeystore -deststorepass $keystorePassword -destkeystore $keystoreLocation -srckeystore wa_pkcs12.p12 -srcstoretype PKCS12
keytool -v -import -alias bundle -trustcacerts -file wa_pkcs12.p12 -keystore $keystoreLocation
