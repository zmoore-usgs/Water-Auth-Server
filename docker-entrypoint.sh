...
keytool -genkeypair -alias tomcat -keyalg RSA -dname "CN=water-auth,OU=Unit,O=Organization,L=City,S=State,C=US" -keystore $keystoreLocation -storepass $keystorePassword -noprompt
