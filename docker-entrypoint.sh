...
openssl pkcs12 -export -in $waterauthserver_SAML_CERT_path -inkey $waterauthserver_SAML_KEY_path -name $keystoreOAuthKey -out saml.p12 -password pass:$keystorePassword
